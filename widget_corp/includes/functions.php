...
// same as password_hash(); in PHP v5.5+
function password_encrypt($password){
  // Tells PHP to use Blowfish with a "cost" of 10
  $hash_format = "$2y$10$";
  // Blowfish slats should be 22-char or more
  $salt_length = 22;
...
function generate_salt($length){
  ...
  // But not '+' which is valid in base64 enchant_broker_set_ordering
...
// same as password_verify(); in PHP v5.5+
